...
module.exports = {
  dev: {
    ...
    // 前端webpack代理转发，前端单方面解决跨域问题
    proxyTable: {
      '/api': {
        target: 'http://121.199.72.39:8080/',//设置你调用的接口域名 别忘了加http192.168.19.25
        // target: 'http://192.168.19.25:8080/',//设置你调用的接口域名 别忘了加http192.168.19.25
        changeOrigin: true,
        pathRewrite: {
